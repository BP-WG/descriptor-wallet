...
impl TaprootScriptTree {
    ...
    ///
    /// NB: the iterator ignores scripts behind hidden nodes. It
    /// iterates the scripts in DFS (and not consensus) order.
    #[inline]
...
/// Iterator over leaf scripts stored in the leaf nodes of the taproot
/// script tree.
///
