    ...
    Self: ToPubkeyScript,
{
    ...
    /// contexts
    fn to_witness(&self, strategy: ConvertInfo) -> Option<Vec<Vec<u8>>>;
}
...
impl ToPubkeyScript for WitnessScript {
    ...
    fn to_pubkey_script(&self, strategy: ConvertInfo) -> Option<PubkeyScript> {
        match strategy {
            ...
            ConvertInfo::SegWitV0 => Some(Script::new_v0_wsh(&self.script_hash()).into()),
...
impl ToPubkeyScript for LockScript {
    ...
    fn to_pubkey_script(&self, strategy: ConvertInfo) -> Option<PubkeyScript> {
        Some(match strategy {
            ...
            ConvertInfo::SegWitV0 => Script::new_v0_wsh(&self.wscript_hash()).into(),
    ...
    fn to_witness(&self, strategy: ConvertInfo) -> Option<Vec<Vec<u8>>> {
        match strategy {
            ...
            ConvertInfo::SegWitV0 | ConvertInfo::NestedV0 => {
                ...
                Some(vec![witness_script.to_bytes()])
            }
            ConvertInfo::Taproot => None,
        }
    }
...
impl ToScripts for bitcoin::PublicKey {
    ...
    fn to_witness(&self, strategy: ConvertInfo) -> Option<Vec<Vec<u8>>> {
        match strategy {
            ConvertInfo::Bare | ConvertInfo::Hashed => None,
            ConvertInfo::SegWitV0 | ConvertInfo::NestedV0 => Some(vec![self.to_bytes()]),
            // Bitcoin public key can't be used in Taproot context
            ConvertInfo::Taproot => None,
        }
    }
    ...
    fn to_pubkey_script(&self, strategy: ConvertInfo) -> Option<PubkeyScript> {
        ...
        Some(
            match strategy {
                ...
                ConvertInfo::SegWitV0 => Script::new_v0_wpkh(&pk.wpubkey_hash()?),
                ConvertInfo::NestedV0 => {
